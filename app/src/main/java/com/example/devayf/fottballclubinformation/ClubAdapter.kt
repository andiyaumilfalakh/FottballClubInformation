...
class ClubAdapter (private val context: Context, private val clubItem: List<ClubItem>, private val listener: (ClubItem)->Unit)
    ...
    class ClubViewHolder(view: View) : RecyclerView.ViewHolder(view){
        private val clubName = view.findViewById<TextView>(R.id.club_name)
        private val clubLogo = view.findViewById<ImageView>(R.id.club_logo)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) : ClubViewHolder{
        return ClubViewHolder(LayoutInflater.from(context).inflate(R.layout.club_information, parent, false))
    }
